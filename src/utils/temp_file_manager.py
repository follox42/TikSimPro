...
if __name__ == "__main__":
    # Basic test
    print("🧪 Test TempFileManager")
    
    with TempFileManager() as temp_manager:
        # Create files for different steps
        trend_file = temp_manager.create_temp_file("trend_analysis", "trends", "json")
        video_file = temp_manager.create_video_file("video_generation")
        audio_file = temp_manager.create_audio_file("audio_generation")
        
        print(f"📁 Files created:")
        print(f"   Trends: {trend_file}")
        print(f"   Video: {video_file}")
        print(f"   Audio: {audio_file}")
        
        # Create fake content
        trend_file.write_text('{"hashtags": ["test"]}')
    ...
    # Test specialized context manager
    with temp_pipeline_step("video_processing") as (manager, step_dir):
        temp_file = step_dir / "processing.tmp"
        temp_file.write_text("processing data")
        print(f"📝 Step file: {temp_file}")
    
    print("✅ Step cleanup completed")